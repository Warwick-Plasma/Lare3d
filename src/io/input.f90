...
CONTAINS
  ...
  SUBROUTINE cfd_Open_Read(filename)
    ...
    CALL MPI_FILE_READ_ALL(cfd_filehandle, FileVersion, 1, &
        MPI_INTEGER, cfd_status, cfd_errcode)

    CALL MPI_FILE_READ_ALL(cfd_filehandle, FileRevision, 1, &
        MPI_INTEGER, cfd_status, cfd_errcode)

    CALL MPI_FILE_READ_ALL(cfd_filehandle, MaxStringLen, 1, &
        MPI_INTEGER, cfd_status, cfd_errcode)
  ...
  SUBROUTINE cfd_Get_Next_Block_Info_All(name, class, TYPE)
    ...
    CALL MPI_FILE_READ_ALL(cfd_filehandle, name_l, MaxStringLen, &
        MPI_CHARACTER, cfd_status, cfd_errcode)

    CALL MPI_FILE_READ_ALL(cfd_filehandle, class_l, MaxStringLen, &
        MPI_CHARACTER, cfd_status, cfd_errcode)
