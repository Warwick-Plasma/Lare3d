...
CONTAINS
  ...
  SUBROUTINE cfd_write_1d_cartesian_grid(name, class, x, rank_write)
    ...
    current_displacement = current_displacement + 1_8 * (2 + nx) * num
  ...
  SUBROUTINE cfd_write_2d_cartesian_grid(name, class, x, y, rank_write)
    ...
    current_displacement = current_displacement + 1_8 * (4 + nx+ny) * num
  ...
  SUBROUTINE cfd_write_3d_cartesian_grid(name, class, x, y, z, rank_write)
    ...
    blocklen = mdlen + 1_8 * (nx+ny+nz) * num
    ...
    current_displacement = current_displacement + 1_8 * (6 + nx+ny+nz) * num
  ...
  SUBROUTINE cfd_write_3d_cartesian_variable_parallel(name, class, dims, &
    ...
    blocklen = mdlen + 1_8 * num * nx * ny * nz
    ...
    current_displacement = current_displacement + 1_8 * num * nx * ny * nz
  ...
  SUBROUTINE cfd_write_2d_cartesian_variable_parallel(name, class, dims, &
    ...
    current_displacement = current_displacement + 1_8 * num * nx * ny
  ...
  SUBROUTINE cfd_write_1d_cartesian_variable_parallel(name, class, dims, &
    ...
    current_displacement = current_displacement + 1_8 * num * nx
