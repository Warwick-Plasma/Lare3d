! This file contains example equilibria
! It is not compiled and is simply a repository for code that can be
! cut/pasted into initial_conditions.f90 as templates
