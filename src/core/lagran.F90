...
CONTAINS
  ...
  SUBROUTINE lagrangian_step
    ...
    ALLOCATE (bx1(0:nx+1,0:ny+1,0:nz+1),by1(0:nx+1,0:ny+1,0:nz+1),bz1(0:nx+1,0:ny+1,0:nz+1),&
         ...
         flux_x(0:nx,0:ny,0:nz),flux_y(0:nx,0:ny,0:nz),flux_z(0:nx,0:ny,0:nz),curlb(0:nx,0:ny,0:nz))
    ...
    DO iz = 0, nz+1
       DO iy = 0, ny+1
          ...
          DO ix = 0, nx+1
             ...
             CALL Get_Pressure(rho(ix,iy,iz) * cv(ix,iy,iz)/cv1(ix,iy,iz), e1, eos_number, ix, iy, iz, pressure(ix,iy,iz))
#ifdef Q_MONO
             ! add shock viscosity
    ...
    DO iz = 0, nz+1
       DO iy = 0, ny+1
          DO ix = 0, nx+1
             ...
             CALL Get_Cs(rho(ix,iy,iz),energy(ix,iy,iz),eos_number,ix,iy,iz,Cs)
             cf = SQRT(cs**2+w1)
  ...
  SUBROUTINE resistive_effects
    ...
    ALLOCATE(k1x(0:nx,0:ny,0:nz),k2x(0:nx,0:ny,0:nz),k3x(0:nx,0:ny,0:nz),k4x(0:nx,0:ny,0:nz))
    ALLOCATE(k1y(0:nx,0:ny,0:nz),k2y(0:nx,0:ny,0:nz),k3y(0:nx,0:ny,0:nz),k4y(0:nx,0:ny,0:nz))
    ALLOCATE(k1z(0:nx,0:ny,0:nz),k2z(0:nx,0:ny,0:nz),k3z(0:nx,0:ny,0:nz),k4z(0:nx,0:ny,0:nz))
    ALLOCATE(c1(0:nx,0:ny,0:nz),c2(0:nx,0:ny,0:nz),c3(0:nx,0:ny,0:nz),c4(0:nx,0:ny,0:nz))
    ...
    DO iz = 1, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 0, nx
             bx(ix,iy,iz) = bx1(ix,iy,iz) + (k1z(ix,iy,iz) - k1z(ix,iy-1,iz)) * dt / dyb(iy) -&
    ...
    DO iz = 1, nz
       DO iy = 0, ny
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             by(ix,iy,iz) = by1(ix,iy,iz) + (- k1z(ix,iy,iz) + k1z(ix-1,iy,iz)) * dt / dxb(ix) +&
    ...
    DO iz = 0, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             bz(ix,iy,iz) = bz1(ix,iy,iz) + (k1y(ix,iy,iz) - k1z(ix-1,iy,iz)) * dt / dxb(ix) -&
    ...
    DO iz = 1, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 0, nx
             bx(ix,iy,iz) = bx1(ix,iy,iz) + (k2z(ix,iy,iz) - k2z(ix,iy-1,iz)) * dt / dyb(iy) -&
    ...
    DO iz = 1, nz
       DO iy = 0, ny
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             by(ix,iy,iz) = by1(ix,iy,iz) + (- k2z(ix,iy,iz) + k2z(ix-1,iy,iz)) * dt / dxb(ix) +&
    ...
    DO iz = 0, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             bz(ix,iy,iz) = bz1(ix,iy,iz) + (k2y(ix,iy,iz) - k2z(ix-1,iy,iz)) * dt / dxb(ix) -&
    ...
    DO iz = 1, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 0, nx
             bx(ix,iy,iz) = bx1(ix,iy,iz) + (k3z(ix,iy,iz) - k3z(ix,iy-1,iz)) * dt / dyb(iy) -&
    ...
    DO iz = 1, nz
       DO iy = 0, ny
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             by(ix,iy,iz) = by1(ix,iy,iz) + (- k3z(ix,iy,iz) + k3z(ix-1,iy,iz)) * dt / dxb(ix) +&
    ...
    DO iz = 0, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             bz(ix,iy,iz) = bz1(ix,iy,iz) + (k3y(ix,iy,iz) - k3z(ix-1,iy,iz)) * dt / dxb(ix) -&
    ...
    DO iz = 1, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 0, nx
             bx(ix,iy,iz) = bx1(ix,iy,iz) + (k3z(ix,iy,iz) - k3z(ix,iy-1,iz)) * dt6 / dyb(iy) -&
    ...
    DO iz = 1, nz
       DO iy = 0, ny
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             by(ix,iy,iz) = by1(ix,iy,iz) + (- k3z(ix,iy,iz) + k3z(ix-1,iy,iz)) * dt6 / dxb(ix) +&
    ...
    DO iz = 0, nz
       DO iy = 1, ny 
          ...
          !DEC$ VECTOR ALWAYS
          DO ix = 1, nx
             bz(ix,iy,iz) = bz1(ix,iy,iz) + (k3y(ix,iy,iz) - k3z(ix-1,iy,iz)) * dt6 / dxb(ix) -&
    ...
    DO iz = 1, nz
       DO iy = 1, ny
          DO ix = 1, nx
             ...
             iym = iy - 1
             izm = iz - 1
             energy(ix,iy,iz) = energy(ix,iy,iz) + (c1(ix,iy,iz) + c1(ixm,iy,iz) + c1(ix,iym,iz) &
                  +c1(ix,iy,izm) + c1(ixm,iym,iz) + c1(ixm,iy,izm) + c1(ix,iym,izm) &
                  + c1(ixm,iym,izm)) * dt6 / (8.0_num * rho(ix,iy,iz))
          END DO
       END DO
    END DO
  ...
  SUBROUTINE rkstep
    ...
    ALLOCATE(jx(-1:nx+1,-1:ny+1,-1:nz+1),jy(-1:nx+1,-1:ny+1,-1:nz+1),jz(-1:nx+1,-1:ny+1,-1:nz+1))
    ...
    IF (.NOT. Cowling_Resistivity) THEN
       ...
       DO iz = 0, nz
          DO iy = 0, ny
             ...
             !DEC$ VECTOR ALWAYS
             DO ix = 0, nx
                flux_x(ix,iy,iz) = - jx(ix,iy,iz) * eta(ix,iy,iz) * dxc(ix) / 2.0_num
                flux_y(ix,iy,iz) = - jy(ix,iy,iz) * eta(ix,iy,iz) * dyc(iy) / 2.0_num
                flux_z(ix,iy,iz) = - jz(ix,iy,iz) * eta(ix,iy,iz) * dzc(iz) / 2.0_num
                !This isn't really curlb. It's actually heat flux
                curlb(ix,iy,iz) = eta(ix,iy,iz) * (jx(ix,iy,iz)**2 + jy(ix,iy,iz)**2 + jz(ix,iy,iz)**2)
             END DO
          END DO
       END DO
    ELSE
       ...
       DO iz = 0, nz
          DO iy = 0, ny
             ...
             DO ix = 0, nx
                ...
                j_par_x = (jx(ix,iy,iz)*bxv + jy(ix,iy,iz)*byv + jz(ix,iy,iz)*bzv) * bxv / MAX(magn_b,none_zero)
                j_par_y = (jx(ix,iy,iz)*bxv + jy(ix,iy,iz)*byv + jz(ix,iy,iz)*bzv) * byv / MAX(magn_b,none_zero)
                j_par_z = (jx(ix,iy,iz)*bxv + jy(ix,iy,iz)*byv + jz(ix,iy,iz)*bzv) * bzv / MAX(magn_b,none_zero)
                ...
                !This isn't really curlb. It's actually heat flux
                curlb(ix,iy,iz) = eta(ix,iy,iz) * magn_j_par**2 + (eta_perp(ix,iy,iz)+eta(ix,iy,iz)) * magn_j_perp**2

                flux_x(ix,iy,iz) = - ((j_par_x * eta(ix,iy,iz) + j_perp_x * (eta_perp(ix,iy,iz)+eta(ix,iy,iz)))&
                     * dxc(ix)/2.0_num)
                flux_y(ix,iy,iz) = - ((j_par_y * eta(ix,iy,iz) + j_perp_y * (eta_perp(ix,iy,iz)+eta(ix,iy,iz)))&
                     * dyc(iy)/2.0_num)
                flux_z(ix,iy,iz) = - ((j_par_z * eta(ix,iy,iz) + j_perp_z * (eta_perp(ix,iy,iz)+eta(ix,iy,iz))))
             END DO
          END DO
       END DO
    ENDIF
