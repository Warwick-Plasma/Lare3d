...
CONTAINS
  ...
  SUBROUTINE mpi_initialise
    ...
    ALLOCATE(vx(-2:nx+2,-2:ny+2,-2:nz+2), vy(-2:nx+2,-2:ny+2,-2:nz+2), vz(-2:nx+2,-2:ny+2,-2:nz+2))
    ALLOCATE(vx1(-2:nx+2,-2:ny+2,-2:nz+2), vy1(-2:nx+2,-2:ny+2,-2:nz+2), vz1(-2:nx+2,-2:ny+2,-2:nz+2))
    ALLOCATE(bx(-2:nx+2,-1:ny+2,-1:nz+2), by(-1:nx+2,-2:ny+2,-1:nz+2), bz(-1:nx+2,-1:ny+2,-2:nz+2))
    ALLOCATE(delta_ke(-1:nx+2,-1:ny+2,-1:nz+2), p_visc(-1:nx+2,-1:ny+2,-1:nz+2))
    ALLOCATE(eta(-1:nx+2,-1:ny+2,-1:nz+2), lambda_i(-1:nx+2,-1:ny+2,-1:nz+2))
    ...
    ALLOCATE(jx_r(0:nx+1,0:ny+1,0:nz+1),jy_r(0:nx+1,0:ny+1,0:nz+1),jz_r(0:nx+1,0:ny+1,0:nz+1))
