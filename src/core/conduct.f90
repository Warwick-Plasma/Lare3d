    ...
    DO iz = -1, nz + 1
      DO iy = -1, ny + 1
        DO ix = -1, nx + 1 
          ...
          uxkx(ix,iy,iz) = uxkx(ix,iy,iz) + b_min**2 * kappa_0 * (e2t * exb)**pow &
              / (bpx**2 + b_min**2) 
          ...
          ! add symmetic conduction near b=0 points 
          uyky(ix,iy,iz) = uyky(ix,iy,iz) + b_min**2 * kappa_0 * (e2t * eyb)**pow &
                / (bpy**2 + b_min**2)  
          ...
          ! add symmetic conduction near b=0 points 
          uzkz(ix,iy,iz) = uzkz(ix,iy,iz) + b_min**2 * kappa_0 * (e2t * ezb)**pow &
              / (bpz**2 + b_min**2)   
      ...
      DO iz = 0, nz + 1
        DO iy = 0, ny + 1
          DO ix = 0, nx + 1  
            ...
            q_shx = &
                (uxkx(ix,iy,iz) + uxkx(ix-1,iy,iz)) * e2t &
                * (energy(ix+1,iy,iz) - energy(ix-1,iy,iz)) / dxc(ix) & 
              + (uxky(ix,iy,iz) + uxky(ix,iy-1,iz)) * e2t &
                * (energy(ix,iy+1,iz) - energy(ix,iy-1,iz)) / dyc(iy) &
              + (uxkz(ix,iy,iz) + uxkz(ix,iy,iz-1)) * e2t &
                * (energy(ix,iy,iz+1) - energy(ix,iy,iz-1)) / dzc(iz) 
            q_shy = &
                (uykx(ix,iy,iz) + uykx(ix-1,iy,iz)) * e2t &
                * (energy(ix+1,iy,iz) - energy(ix-1,iy,iz)) / dxc(ix) & 
              + (uyky(ix,iy,iz) + uyky(ix,iy-1,iz)) * e2t &
                * (energy(ix,iy+1,iz) - energy(ix,iy-1,iz)) / dyc(iy) &
              + (uykz(ix,iy,iz) + uykz(ix,iy,iz-1)) * e2t &
                * (energy(ix,iy,iz+1) - energy(ix,iy,iz-1)) / dzc(iz) 
            q_shz = &
                (uzkx(ix,iy,iz) + uzkx(ix-1,iy,iz)) * e2t &
                * (energy(ix+1,iy,iz) - energy(ix-1,iy,iz)) / dxc(ix) & 
              + (uzky(ix,iy,iz) + uzky(ix,iy-1,iz)) * e2t &
                * (energy(ix,iy+1,iz) - energy(ix,iy-1,iz)) / dyc(iy) &
              + (uzkz(ix,iy,iz) + uzkz(ix,iy,iz-1)) * e2t &
                * (energy(ix,iy,iz+1) - energy(ix,iy,iz-1)) / dzc(iz) 
            ...
            q_f = 42.85_num * flux_limiter * rho(ix,iy,iz) &
              * MIN(e2t * energy(ix,iy,iz), temperature_100mk)**1.5_num            
          ...
          DO iy = 1, ny               
             DO ix = x1, nx, 2
              ...
              a2 = a2 + uxky(ix,iy,iz) * e2t &
                * (energy(ix+1,iy+1,iz) + energy(ix,iy+1,iz) - energy(ix+1,iy-1,iz) &
                - energy(ix,iy-1,iz)) &
                / (2.0_num * dxb(ix) * (dyc(iy) + dyc(iy-1)))  
              a2 = a2 - uxky(ix-1,iy,iz) * e2t &
                * (energy(ix,iy+1,iz) + energy(ix-1,iy+1,iz) - energy(ix,iy-1,iz) &
                - energy(ix-1,iy-1,iz)) &
                / (2.0_num * dxb(ix) * (dyc(iy) + dyc(iy-1)))  
              ! terms not containing energy(ix,iy,iz) resulting from 
              ! d^2/dxdz cross derivatives                  
              a2 = a2 + uxkz(ix,iy,iz) * e2t &
                * (energy(ix+1,iy,iz+1) + energy(ix,iy,iz+1) - energy(ix+1,iy,iz-1) &
                - energy(ix,iy,iz-1)) &
                / (2.0_num * dxb(ix) * (dzc(iz) + dzc(iz-1)))  
              a2 = a2 - uxkz(ix-1,iy,iz) * e2t &
                * (energy(ix,iy,iz+1) + energy(ix-1,iy,iz+1) - energy(ix,iy,iz-1) &
                - energy(ix-1,iy,iz-1)) &
                / (2.0_num * dxb(ix) * (dzc(iz) + dzc(iz-1)))
              ...
              a2 = a2 + uykx(ix,iy,iz) * e2t &
                * (energy(ix+1,iy+1,iz) + energy(ix+1,iy,iz) - energy(ix-1,iy+1,iz) &
                - energy(ix-1,iy,iz)) &
                / (2.0_num * dyb(iy) * (dxc(ix) + dxc(ix-1)))  
              a2 = a2 - uykx(ix,iy-1,iz) * e2t &
                * (energy(ix+1,iy,iz) + energy(ix+1,iy-1,iz) - energy(ix-1,iy,iz) &
                - energy(ix-1,iy-1,iz)) &
                / (2.0_num * dyb(iy) * (dxc(ix) + dxc(ix-1)))                     
              ! terms not containing energy(ix,iy,iz) resulting from 
              ! d^2/dydz cross derivatives
              a2 = a2 + uykz(ix,iy,iz) * e2t &
                * (energy(ix,iy+1,iz+1) + energy(ix,iy,iz+1) - energy(ix,iy+1,iz-1) &
                - energy(ix,iy,iz-1)) &
                / (2.0_num * dyb(iy) * (dzc(iz) + dzc(iz-1)))  
              a2 = a2 - uykz(ix,iy-1,iz) * e2t &
                * (energy(ix,iy,iz+1) + energy(ix,iy-1,iz+1) - energy(ix,iy,iz-1) &
                - energy(ix,iy-1,iz-1)) &
                / (2.0_num * dyb(iy) * (dzc(iz) + dzc(iz-1)))
              ...
              a2 = a2 + uzkx(ix,iy,iz) * e2t &
                * (energy(ix+1,iy,iz+1) + energy(ix+1,iy,iz) - energy(ix-1,iy,iz+1) &
                - energy(ix-1,iy,iz)) &
                / (2.0_num * dzb(iz) * (dxc(ix) + dxc(ix-1)))  
              a2 = a2 - uzkx(ix,iy,iz-1) * e2t &
                * (energy(ix+1,iy,iz) + energy(ix+1,iy,iz-1) - energy(ix-1,iy,iz) &
                - energy(ix-1,iy,iz-1)) &
                / (2.0_num * dzb(iz) * (dxc(ix) + dxc(ix-1)))  
              ! terms not containing energy(ix,iy,iz) resulting from 
              ! d^2/dzdy cross derivatives
              a2 = a2 + uzky(ix,iy,iz) * e2t &
                * (energy(ix,iy+1,iz+1) + energy(ix,iy+1,iz) - energy(ix,iy-1,iz+1) &
                - energy(ix,iy-1,iz)) &
                / (2.0_num * dzb(iz) * (dyc(iy) + dyc(iy-1)))  
              a2 = a2 - uzky(ix,iy,iz-1) * e2t &
                * (energy(ix,iy+1,iz) + energy(ix,iy+1,iz-1) - energy(ix,iy-1,iz) &
                - energy(ix,iy-1,iz-1)) &
                / (2.0_num * dzb(iz) * (dyc(iy) + dyc(iy-1)))     
