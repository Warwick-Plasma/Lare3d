...
CONTAINS
  ...
  SUBROUTINE set_initial_conditions
    ...
    REAL(num) :: BJ0,DJ0,BJ1,DJ1,BY0,DY0,BY1,DY1
    REAL(num) :: B2J0,D2J0,B2J1,D2J1,B2Y0,D2Y0,B2Y1,D2Y1
...
!Case 3 perturbation
    ...
    amp = 1.e-4_num
!    dx = 0.1_num * dxb(nx/2,ny/2,nz/2)
!    dy = 0.1_num * dyb(nx/2,ny/2,nz/2)
    dx = 0.1_num * dxb(nx/2)
    dy = 0.1_num * dyb(ny/2)
    DO ix = -1,nx+2
      DO iy = -1,ny+2
        DO iz = -1,nz+2
!
!          rho = ix*100.0_num+iy*10_num+iz*1.0_num
!
