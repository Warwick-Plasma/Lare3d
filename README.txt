...
"lare3d-3.0.0.tar.gz". These are tarred and gzipped packages of the code
which can be unpacked with the command "tar xzf lare3d-3.0.0.tar.gz".
This will create a directory called "lare3d-3.0.0".
...
of working with the LareXd codebases. In theory, all the changes necessary for
compiling Lare on any given environment should be possible using command-line
variables.
...
This library used by Lare3d for reading and writing the files is automatically
...
LareXd will require an update of the VisIt reader, but if you do start to
...
Note that older versions of LareXd used the CFD format. This is now obsolete
